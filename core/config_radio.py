...
Constantes de mensagens ao ouvinte:
    ...
    MSG_AGUARDANDO_PEDIDO, MSG_PRODUCAO_ATIVADO, MSG_PILULA_PREFIXO,
    MSG_MENU_POS_SUCESSO, MSG_ENCERRAMENTO
...
GENERO_ACEITO = (
    ...
    "rap nacional/brasileiro e gospel; EXCEÇÃO: músicas dos Racionais MC's são aceitas. "
    "Todo sertanejo é aceito, EXCETO "
...
MSG_NAO_REPERTORIO = (
    ...
    "\n\nSomos especializados em flashbacks: pop, rock, MPB, samba, sertanejo "
    "raiz e os grandes sucessos que cresceram com você."
...
MSG_PILULA_PREFIXO = "*CURIOSIDADE:*\n\n"

# Menu enviado quando o ouvinte interage dentro da janela pós-sucesso (10 min).
# Substitui a interpretação livre por opções claras durante esse intervalo.
MSG_MENU_POS_SUCESSO = (
